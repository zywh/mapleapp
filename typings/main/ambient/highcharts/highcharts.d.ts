...
export interface HighchartsPosition {
    align?: string;
...
export interface HighchartsDateTimeFormats {
    /**
     * @default '%H:%M:%S.%L'
     */
    millisecond?: string;
...
export interface HighchartsAxisEvent extends Event {
    min: number;
    max: number;
}

export interface HighchartsAxisLabels {
    /**
...
export interface HighchartsMousePlotEvents {
 ...
 */
export interface HighchartsPlotLabel {
    /**
...
export interface HighchartsPlotBands {
    /**
 ...
 * on one of the axes.
 */
export interface HighchartsPlotLines {
    /**
...
export interface HighchartsAxisTitle {
    /**
...
export interface HighchartsAxisBreak {
    /**
...
export interface HighchartsColorAxisDataClass {
    from?: number;
    to?: number;
    color?: string;
    name?: string;
 ...
 */
export interface HighchartsColorAxisOptions {
    /**
...
export interface HighchartsExtremes {
    /**
...
export interface HighchartsAnimation {
    /**
...
export interface HighchartsAddSeriesEvent extends Event {
    /**
...
export interface HighchartsAxisValueOptions extends HighchartsAxisOptions {
    /**
...
export interface HighchartsChartClickEvent extends Event {
    /**
...
export interface HighchartsChartDrilldownEvent extends Event {
    /**
...
export interface HighchartsChartSelectionEvent extends Event {
    /**
...
export interface HighchartsChartEvents {
    /**
...
export interface HighchartsLinearGradient {
    x1: number;
    y1: number;
    x2: number;
    y2: number;
...
export interface HighchartsGradient {
...
export interface HighchartsChartOptions3dFrame {
    /**
...
export interface HighchartsChartOptions3d {
    /**
...
export interface HighchartsShadow {
    /**
     * @default 'black'
     */
    color?: string;
...
export interface HighchartsChartResetZoomButton {
    /**
...
export interface HighchartsButtonTheme {
...
export interface HighchartsButtonStatesTheme extends HighchartsButtonTheme {
    /**
...
export interface HighchartsChartOptions {
    /**
...
export interface HighchartsCSSObject {
    background?: string;
    border?: string;
    color?: string;
    cursor?: string;
...
export interface HighchartsCreditsOptions {
    /**
...
export interface HighchartsDataSeriesMapping {
    [pointPropertyName: string]: number;
}

/**
 * The Data module provides a simplified export interface for adding data to a chart from sources like CVS, HTML tables or grid
 ...
 * series.data option.
 */
export interface HighchartsDataOptions {
    /**
 ...
 */
export interface HighchartsDrilldownOptions {
    /**
...
export interface HighchartsMenuItem {
    /**
...
export interface HighchartsButton {
    /**
...
export interface HighchartsExportingContextButton extends HighchartsButton {
    /**
...
export interface HighchartsExportingOptions {
    /**
 ...
 */
export interface HighchartsGlobalObject {
    /**
...
export interface HighchartsLabelItem {
    html: string;
    style: HighchartsCSSObject;
}

export interface HighchartsLabelsOptions {
    items?: HighchartsLabelItem[];
    style?: HighchartsCSSObject;
}

export interface HighchartsLangObject {
    /**
...
export interface HighchartsLegendNavigationOptions {
    /**
...
export interface HighchartsLegendTitleOptions {
    /**
...
export interface HighchartsLegendOptions {
    /**
 ...
 */
export interface HighchartsLoadingOptions {
    /**
 ...
 */
export interface HighchartsNavigationOptions {
    /**
 ...
 */
export interface HighchartsNoDataOptions {
    /**
...
export interface HighchartsPaneBackground {
    /**
 ...
 */
export interface HighchartsPaneOptions {
    /**
...
export interface HighchartsDataLabels {
    /**
...
export interface HighchartsPieDataLabels extends HighchartsDataLabels {
    /**
...
export interface HighchartsAreaCheckboxEvent extends Event {
    /**
...
export interface HighchartsAreaClickEvent extends Event {
    /**
...
export interface HighchartsPlotEvents {
    /**
...
export interface HighchartsMarkerState {
    /**
...
export interface HighchartsMarkerHoverState extends HighchartsMarkerState {
    /**
...
export interface HighchartsMarker extends HighchartsMarkerState {
    /**
...
export interface HighchartsPointEvents {
    /**
...
export interface HighchartsHalo {
    /**
...
export interface HighchartsLineStates {
    /**
...
export interface HighchartsBarStates {
    /**
...
export interface HighchartsPieStates extends HighchartsBarStates, HighchartsLineStates { }

export interface HighchartsAreaZone {
    /**
...
export interface HighchartsRangeDataLabels {
    /**
     * The alignment of the data label compared to the point. If right, the right side of the label should be touching
     * the point. For points with an extent, like columns, the alignments also dictates how to align it inside the box,
     * as given with the inside option. Can be one of 'left', 'center' or 'right'.
...
export interface HighchartsDial {
    /**
...
export interface HighchartsPivot {
    /**
 ...
 */
export interface HighchartsTreeMapLevel {
    /**
 ...
 */
export interface HighchartsSeriesChart {
    /**
...
export interface HighchartsAreaChart extends HighchartsSeriesChart {
    /**
...
export interface HighchartsAreaRangeChart extends HighchartsAreaChart {
    /**
...
export interface HighchartsAreaSplineChart extends HighchartsAreaChart {
}

export interface HighchartsAreaSplineRangeChart extends HighchartsAreaRangeChart {
}

export interface HighchartsBarChart extends HighchartsSeriesChart {
    /**
 ...
 * maximum).
 */
export interface HighchartsBoxPlotChart extends HighchartsErrorBarChart {
    /**
 ...
 * the Z value.
 */
export interface HighchartsBubbleChart extends HighchartsSeriesChart {
    /**
...
export interface HighchartsColumnChart extends HighchartsBarChart {
}
 ...
 */
export interface HighchartsColumnRangeChart extends HighchartsColumnChart {
    dataLabels?: HighchartsRangeDataLabels;
}
 ...
 */
export interface HighchartsErrorBarChart extends HighchartsSeriesChart {
    /**
     * When using automatic point colors pulled from the options.colors collection, this option determines whether the
 ...
 */
export interface HighchartsFunnelChart extends HighchartsSeriesChart {
    /**
     * The color of the border surrounding each column or bar.
     * @default '#FFFFFF'
     */
 ...
 */
export interface HighchartsGaugeChart extends HighchartsSeriesChart {
    /**
 ...
 */
export interface HighchartsHeatMapChart extends HighchartsSeriesChart {
    /**
     * The color of the border surrounding each column or bar.
     * @default '#FFFFFF'
     */
...
export interface HighchartsLineChart extends HighchartsSeriesChart {
    /**
     * Whether to apply steps to the line. Possible values are left, center and right. Prior to 2.3.5, only left was
     * supported.
     * @default false
 ...
 */
export interface HighchartsPieChart extends HighchartsSeriesChart {
    /**
 ...
 * file.
 */
export interface HighchartsPolygonChart extends HighchartsSeriesChart {
    /**
...
export interface HighchartsPyramidChart extends HighchartsSeriesChart {
    /**
...
export interface HighchartsScatterChart extends HighchartsSeriesChart { }
 ...
 * itself.
 */
export interface HighchartsSolidGaugeChart extends HighchartsSeriesChart {
    /**
     * Allow the dial to overshoot the end of the perimeter axis by this many degrees. Say if the gauge axis goes from 0
...
export interface HighchartsSplineChart extends HighchartsSeriesChart { }
 ...
 */
export interface HighchartsTreeMapChart extends HighchartsSeriesChart {
    /**
...
export interface HighchartsWaterFallChart extends HighchartsBarChart {
    /**
     * A name for the dash style to use for the graph. Applies only to series type having a graph, like line, spline,
     * area and scatter in case it has a lineWidth. The value for the dashStyle include:
     * - Solid
 ...
 */
export interface HighchartsPlotOptions {
...
/* You will rarely, if ever, want to use this export interface directly. Instead it is much more useful to use one of the derived
 * export interfaces (HighchartsAreaChartSeriesOptions, HighchartsLineChartSeriesOptions, etc.)
 */
export interface HighchartsIndividualSeriesOptions {
    type?: string;
    /**
...
export interface HighchartsSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsSeriesChart { }

export interface HighchartsAreaChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsAreaChart { }
export interface HighchartsAreaRangeChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsAreaRangeChart { }
export interface HighchartsAreaSplineChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsAreaSplineChart { }
export interface HighchartsAreaSplineRangeChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsAreaSplineRangeChart { }
export interface HighchartsBarChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsBarChart { }
export interface HighchartsBoxPlotChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsBoxPlotChart { }
export interface HighchartsBubbleChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsBubbleChart { }
export interface HighchartsColumnChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsColumnChart { }
export interface HighchartsColumnRangeChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsColumnRangeChart { }
export interface HighchartsErrorBarChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsErrorBarChart { }
export interface HighchartsFunnelChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsFunnelChart { }
export interface HighchartsGaugeChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsGaugeChart { }
export interface HighchartsHeatMapSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsHeatMapChart { }
export interface HighchartsLineChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsLineChart { }
export interface HighchartsPieChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsPieChart { }
export interface HighchartsPolygonChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsPolygonChart { }
export interface HighchartsPyramidChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsPyramidChart { }
export interface HighchartsScatterChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsScatterChart { }
export interface HighchartsSolidGaugeChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsSolidGaugeChart { }
export interface HighchartsSplineChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsSplineChart { }
export interface HighchartsTreeMapChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsTreeMapChart { }
export interface HighchartsWaterFallChartSeriesOptions extends HighchartsIndividualSeriesOptions, HighchartsWaterFallChart { }
 ...
 */
export interface HighchartsSubtitleOptions {
    /**
...
export interface HighchartsTitleOptions {
    /**
...
export interface HighchartsCrosshairObject {
    color?: string;
    width?: number;
...
export interface HighchartsPlotPoint {
    plotX: number;
    plotY: number;
}

export interface HighchartsTooltipOptions extends HighchartsSeriesTooltipOptions {
    /**
...
export interface HighchartsSeriesTooltipOptions {
    /**
...
export interface HighchartsOptions {
    ...
    /**
     * The Data module provides a simplified export interface for adding data to a chart from sources like CVS, HTML tables or
...
export interface HighchartsGlobalOptions extends HighchartsOptions {
    /**
     * Global options that don't apply to each chart. These options, like the lang options, must be set using the
     * Highcharts.setOptions method.
     */
...
export interface HighchartsDateFormatSpecifiers
{
 ...
 */
export interface HighchartsAxisObject {
    /**
 ...
 */
export interface HighchartsChartObject {
    /**
 ...
 */
export interface HighchartsElementObject {
    /**
 ...
 */
export interface HighchartsRendererObject {
    /**
...
export interface HighchartsRenderer {
 ...
 */
export interface HighchartsPointObject {
    /**
 ...
 * for example plotOptions.line. Next, options for one single series are given in the series array.
 */
export interface HighchartsSeriesObject {
    /**
 ...
 */
//declare Highcharts: HighchartsStatic;
